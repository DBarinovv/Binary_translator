...
const elf::Elf64_Off 	C_my_p_offset = 0x0000000000000078;
const elf::Elf64_Addr	C_my_p_vaddr  = 0x0000000000400078;
const elf::Elf64_Addr	C_my_p_paddr  = 0x0000000000400078;
